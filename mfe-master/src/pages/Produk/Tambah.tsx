...
export const ProdukTambah: React.FC = () => {
  ...
  const validate = (): boolean => {
    ...
    if (!formData.categoryId) {
      err.categoryId = 'Kategori wajib dipilih.';
    }
    setErrors(err);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    showLoading('Menyimpan produk ke database API...');
    try {
    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Produk baru akan langsung disimpan ke database backend melalui endpoint <code className="bg-gray-100 text-xs px-1 py-0.5 rounded">POST /api/products</code>.
          </p>
        </div>
      ...
      {apiError && (
        <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex items-start gap-3 text-sm text-red-800">
          ...
          <div>
            <h4 className="font-semibold text-red-900">Gagal Menyimpan ke API</h4>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="md:col-span-2 space-y-1.5">
                ...
                <textarea
                  ...
                  placeholder="Rincian spesifikasi, bahan, atau kegunaan produk..."
        ...
        <Card className="shadow-xs">
          <CardHeader className="pb-4">
            ...
            <CardDescription className="text-xs text-gray-500 mt-0.5">
              Atur harga dasar jual dan persentase potongan harga promosi.
            </CardDescription>
          </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-start">
              <div className="md:col-span-2 space-y-1.5">
                ...
                <p className="text-xs text-gray-500">
                  Tautan langsung ke file gambar (JPG, PNG, WebP).
                </p>
              </div>
