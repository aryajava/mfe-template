    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 rounded-xl bg-indigo-100 text-indigo-700 flex items-center justify-center shadow-xs">
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2.5">
                        <div className="h-7 w-7 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center text-xs font-mono shrink-0">
                          {g.icon ? g.icon.substring(0, 2).toUpperCase() : 'GM'}
                        </div>
                        <div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-100 w-full max-w-lg overflow-hidden">
            ...
            <form onSubmit={handleFormSubmit} className="p-5 space-y-4">
              ...
              <div>
                ...
                <Input
                  type="text"
                  placeholder="contoh: folder_special, payments, settings"
                  value={formData.icon}
