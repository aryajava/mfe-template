...
import { Settings, BarChart3, FileText, Navigation } from 'lucide-react';

const Home: React.FC = () => {
  return (
    <div className="p-6">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">MFE Hallo - Home</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Link to="detail">
          <div className="bg-white rounded-lg border p-6 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
