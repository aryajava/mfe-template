    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50/90 relative overflow-hidden px-4 py-12 selection:bg-orange-500 selection:text-white">
      ...
      <div className="w-full max-w-[400px] flex flex-col items-center relative z-10">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-orange-600 text-white shadow-md shadow-orange-600/20 mb-3 transition-transform hover:scale-105 duration-200">
            <Store className="w-6 h-6" strokeWidth={2.2} />
          </div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">{title}</h1>
          <p className="text-xs text-gray-500 mt-1 font-medium max-w-xs mx-auto leading-relaxed">
            {subtitle}
          </p>
        </div>

        {/* Card Box Login */}
        <div className="w-full bg-white border border-gray-200/80 rounded-2xl shadow-xl shadow-slate-200/60 p-6 sm:p-7 transition-all duration-200">
          {children}
        </div>
